...
export const scheduledSuggestionSchema = z.object({
  ...
  // Tags a block as machine-generated by a specific recurring derivation (e.g.
  // daily homecoming) so a later run can find and update it instead of piling
  // up a duplicate. Stored on the Google event's extended properties.
  derivedKind: z.enum(["daily_homecoming"]).optional()
